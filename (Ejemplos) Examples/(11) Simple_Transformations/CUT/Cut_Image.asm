# ---------------- MAIN ---------------------------------------------
# Nombre:  Cut_Image.asm
# Funcion: Programa que imprime una imagen transformada en el bitmap display
# y lo convierte en una imagen dinámica, una vez hecho, la corta y pega en otras 
...
# - RECTANGLE.s
# - REMOVE.s
# Display: 512x512, 0x100400000
# Ayuda:
# Impresión de Imágenes: Help(7)
# Creación de Imágenes Dinámicas: Help(11)
# Transformaciónes Dinámicas: Help(12)
# -------------------------------------------------------------------

# ---------------- CONSTANTES ---------------------------------------
				# Nota: El programa puede ejecutarse tan rapidamente que la creación del ID y
				# el corte y pegado de la imagen pueden no llegar a verse. Activar DEBUG_MODE a 1 para
				# realentizar la ejecución del programa
				.eqv DEBUG_MODE 0
...
# Bucle para realentizar el programa
wait:
		li t0, 0xffff			# Maximo tiempo de espera
		li t1,0			# Contador
bucle:
		bge t1,t0, exit		# Si el contador alcanza el final, sal
